...
if num_cal ==5
%%5 poses
par_location(:,1) = [-1.4;-0.6;5];
par_location(:,2) = [0;-1;5];
...
if num_cal ==10
par_location(:,1) = [-1.4;-0.6;5];
par_location(:,2) = [0;-0.8;5];
par_location(:,3) = [1;0;5];
par_location(:,4) = [-5;1;15];
par_location(:,5) = [5;-1;15];
par_location(:,6) = [-0.8;-0.4;3];
par_location(:,7) = [-2;0;10];
par_location(:,8) = [2;0;10];
par_location(:,9) = [0;1;15];
par_location(:,10) = [0;-2;15];
end

%%20 poses
if num_cal ==20
par_location(:,11) =[-0.2;-0.4;3];
par_location(:,12) = [0.25;-0.4;3];
par_location(:,6) = [-0.75;-0.4;3];

par_location(:,1) = [-0.8;-0.2;5];
par_location(:,2) = [-0.4;-0.9;5];
par_location(:,3) = [1;-0.9;5];
par_location(:,13) = [1;0.1;5];

par_location(:,16) = [0;-0.5;8];
par_location(:,17) = [2;-1.4;8];
par_location(:,18) = [-3;0;8];

par_location(:,7) = [-2;-1.5;10];
par_location(:,8) = [2;0;10];
par_location(:,14) = [0;-1.5;10];
par_location(:,15) = [-1;-1;10];
par_location(:,19) = [-3;1;10];
par_location(:,20) = [2;-1;10];
...
%undistortion
% Points_c_final_undistortion=undistortion(Points_c_final,Ins_para_P,resolution); %仿真用
Points_c_final_undistortion=undistortion_reality(Points_c_final,Ins_para_P,resolution); %实际标定用
%cal
