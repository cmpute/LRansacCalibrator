function [L_l,points_3d,image_gin_]=Select_Feature_Points_old(num_L_l)
...
% %% int图像优化
% % aa = find (image_int<30);
% % image_int(aa)= 30;
% % image_int = image_int-30;
% image_int_s = image_int ;
% image_int = log(image_int+1) ;
% image_int = image_int/max(max(image_int));
% 
% 
% %%
% figure()
