function Tht=P_method_cal(Points_c_final_undistortion,Points_l_final,num_x,num_y,num_cal,Ins_para_P_nodistortion)
...
% Tht_initial=[-pi/2;-pi/2;0;0.19;-0.66;-1.72];
